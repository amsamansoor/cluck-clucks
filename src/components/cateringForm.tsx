...
const CateringForm = () => {
  ...
  <div className="max-w-4xl mx-auto border-3 border-[#db5038] p-4" style={{ boxSizing: 'border-box' }}>
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-extrabold text-red-500 mb-10 text-center uppercase tracking-wide">
